...
<section class="px-4 lg:px-8 min-h-[100vh] max-h-[100vh] relative overflow-hidden">
  <img src="{{ asset('img/banner_mister_miss_sumsel.jpg') }}" alt="banner" class="absolute top-0 left-0 w-full h-full object-cover object-center">
    <div class="absolute left-1/2 flex flex-col items-center -translate-x-1/2 top-1/2 -translate-y-1/2 text-center">

        <a
            href="#about"
            class="bg-gold/80 hover:bg-gold text-black transition-all duration-200 py-2 px-3 mt-6 rounded-sm"
        >
            More About Us
        </a>
    </div>
