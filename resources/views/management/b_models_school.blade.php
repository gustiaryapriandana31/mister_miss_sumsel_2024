    ...
    <div class="container">
        ...
        <section class="my-10 px-6 py-12 text-white font-sans bg-gradient-to-r from-navy to-sky-800 min-[700px :px-10 md:px-16 md:flex md:gap-x-20 lg:mb-12 lg:gap-x-24 min-[1150px]:gap-28 relative rounded-md">
            ...
            <div class="md:basis-1/3">
                <a href="https://docs.google.com/forms/d/1sYCbYsWoxdRbzLfK5ubTXjkVtY4DnDJUUQmab4D9CDA/edit" target="_blank" class="text-sm inline-block mt-7 text-center z-10 bg-white hover:bg-navy py-3 px-5 text-navy hover:text-white font-bold rounded-md shadow-md md:px-8 md:max-w-max md:self-start lg:text-lg">Daftar Sekarang</a>
